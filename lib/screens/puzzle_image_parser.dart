...
class PuzzleImageParser {
  ...
  static Future<void> _loadPuzzleDefinitions() async {
    try {
      ...
      print('Error loading puzzle definitions: $e');
  ...
  static Future<void> _loadPuzzleFromAssets() async {
    try {
      ...
      print('No puzzle index found, loading individual sets...');
  ...
  static Future<void> _loadPuzzleSet(String setName) async {
    try {
      ...
      print('Loaded ${puzzles.length} puzzles from $setName');
    } catch (e) {
      print('Error loading puzzle set $setName: $e');
    }
  }
  ...
  static Future<bool> importPuzzlesFromJson(String jsonString, String setName) async {
    try {
      ...
      print('Successfully imported ${puzzleData.puzzles.length} puzzles as set: $setName');
      return true;
    } catch (e) {
      print('Error importing puzzles: $e');
      return false;
    }
  }
  ...
  static void _validateFen(String fen, String puzzleId) {
    ...
    if (parts.length != 6) {
      print('ERROR in $puzzleId: FEN should have 6 parts, got ${parts.length}');
      return;
    }
    ...
    if (ranks.length != 8) {
      print('ERROR in $puzzleId: FEN should have 8 ranks, got ${ranks.length}');
      return;
    }
    ...
    if (totalPieces == 32) {
      print('WARNING in $puzzleId: All 32 pieces present - might be starting position');
    } else if (totalPieces > 30) {
      print('WARNING in $puzzleId: $totalPieces pieces - might be too many for a puzzle');
    } else {
      print('OK $puzzleId: $totalPieces pieces');
    }
  }
